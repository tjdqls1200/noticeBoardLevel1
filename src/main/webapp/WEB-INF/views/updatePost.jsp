...
<div class="container">
  <h2>게시판 글쓰기</h2>
  <form action="/noticeBoard/updatePost/${updatePost.postId}" method="post">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="title"
             placeholder="제목을 입려하세요" name="title"
    ...
    <div class="form-group">
      ...
      <output class="form-control" id="writer">${updatePost.writer}</output>
    </div>
    <div class="form-group">
